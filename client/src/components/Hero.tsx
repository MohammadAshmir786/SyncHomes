...
export default function Hero() {
  ...
  return (
    <section
      className="hero relative min-h-[calc(100vh-72px)] flex items-center justify-center overflow-hidden"
      id="home"
    >
      ...
      <div className="z-10 container mx-auto px-6 py-20">
          ...
          <div className="space-y-8">
            ...
            >
              <h1 className="text-5xl md:text-6xl font-bold text-white leading-tight mb-4">
                Build Your Dream
                <span className="text-transparent bg-gradient-to-r from-blue-400 to-blue-600 bg-clip-text ml-3">
                  Home
                </span>
              </h1>
            ...
            >
              <a
                href="#projects"
                className="px-8 py-4 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-semibold rounded-lg hover:shadow-2xl hover:shadow-blue-500/50 transform hover:scale-105 transition-all duration-300"
              >
                Explore Projects
              </a>
              <a
                href="#contact"
                className="px-8 py-4 border-2 border-blue-400 text-blue-400 font-semibold rounded-lg hover:bg-blue-400/10 transform hover:scale-105 transition-all duration-300"
              >
                Get Started
              </a>
            </div>
        ...
        <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2">
          <div className="flex flex-col items-center gap-2 animate-bounce">
            <a href="#about" className="flex flex-col items-center gap-1 text-gray-400 hover:text-blue-400 transition-colors duration-300">

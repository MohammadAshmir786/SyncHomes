...
export default function Navbar() {
  ...
  return (
    ...
    >
      ...
      <div className="w-full h-1 bg-blue-100/70 border-t border-blue-200/70 relative overflow-hidden">
        <div
          className="h-full bg-gradient-to-r from-blue-600 to-blue-700 transition-[width] duration-200 ease-linear"
